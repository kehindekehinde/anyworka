...
const Menu =()=> (
    ...
    <p> <a href="#features">Find Services</a></p>
    <p> <a href="#possibility">Find Work</a></p>
    <p> <a href="#blog">Company</a></p>
    <p> <a href="#whatanyworkaNAv">Contact Us</a></p>
    </React.Fragment>
  )
  ...
  return (
    <div className="anyworka__navbar">
      ...
      <div className="anyworka__navbar-menu_container-links-sign">
        <button type="button"><p>Log in</p></button>
        <button type="button"><p>Sign Up</p></button>
        </div> 
